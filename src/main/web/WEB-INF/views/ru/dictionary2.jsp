...
<head>
    ...
    <script type="text/javascript">
        ...
        dictionaryApp.controller('DictionaryCtrl', ['$scope', '$http', function (scope, http) {
            http.get('/ru/dictionary/all').success(function (data) {
                scope.words = data;
            });
        }]);
...
<body ng-controller="DictionaryCtrl">
<!-- Static navbar -->
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <form class="navbar-form navbar-left" role="search">
                    <div class="dropdown">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Search" id="word" autocomplete="off" ng-model="query">
                        </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                    <tr ng-repeat="word in words | filter:query">
                        <td>{{word.english}}</td>
                        <td>{{word.russian}}</td>
                        <td>{{word.meaning}}</td>
                        <td>{{word.example}}</td>
